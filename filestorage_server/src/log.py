...
#all log info 
all_handler = logging.handlers.TimedRotatingFileHandler('./src/data/log/all.log',when='midnight',
...
#error log info
err_handler = logging.handlers.TimedRotatingFileHandler('./src/data/log/err.log',when='midnight',
